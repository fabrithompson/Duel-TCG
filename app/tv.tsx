...
const styles = StyleSheet.create({
  ...
  avisoTitulo: { fontFamily: Typography.display.bold, fontSize: 24, letterSpacing: -0.7, textAlign: 'center' },
  ...
  titulo: { fontFamily: Typography.display.bold, fontSize: 26, lineHeight: 30, letterSpacing: -0.78, marginTop: 6 },
  timerZona: { flex: 1, alignItems: 'center', justifyContent: 'center', paddingVertical: 12 },
  timer: { fontFamily: Typography.display.light },
  ...
  celdaMesa: { fontFamily: Typography.display.semibold, fontSize: 13 },
  ...
  podioPos: { fontFamily: Typography.display.bold, fontSize: 13, minWidth: 16 },
  podioNombre: { flex: 1, fontFamily: Typography.fontFamily.medium, fontSize: 12.5 },
  podioPts: { fontFamily: Typography.display.regular, fontSize: 12 },
});
