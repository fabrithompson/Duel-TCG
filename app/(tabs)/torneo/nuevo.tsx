...
const styles = StyleSheet.create({
  ...
  contador: { fontFamily: Typography.display.medium, fontSize: 11.5 },
  ...
  pozo: { fontFamily: Typography.display.bold, fontSize: 30, marginTop: 8 },
  puesto: { paddingVertical: 11, borderBottomWidth: 1, gap: 8 },
  puestoFila: { flexDirection: 'row', alignItems: 'center', gap: 12 },
  puestoNumero: { fontFamily: Typography.display.bold, fontSize: 17, minWidth: 30 },
  ...
  comprometidosValor: { fontFamily: Typography.display.semibold, fontSize: 12.5 },
});
